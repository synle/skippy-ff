...
3. **Add a test for every behavior change** in `helpers/storage.js`. Adapter DOM-selector changes are tested manually in the browser (see `DEV.md` § Debugging) — site DOMs churn too fast to be worth fixturing.
